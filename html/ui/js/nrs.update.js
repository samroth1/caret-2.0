...
var NRS = (function(NRS, $, undefined) {
		...
		if (NRS.inApp) {
			if (NRS.appPlatform && NRS.appVersion) {
				...
				if (new Date() > noticeDate) {
					...
					var downloadUrl = "https://github.com/caret-team/caretcoin/releases";
	...
	NRS.downloadClientUpdate = function(version) {
		...
		if (NRS.inApp) {
			...
			$("#nrs_update_iframe").attr("src", "https://github.com/caret-team/caretcoin/releases/download/" + NRS.downloadedVersion.versionNr + "/caretcoin-" + NRS.downloadedVersion.versionNr + ".zip");
