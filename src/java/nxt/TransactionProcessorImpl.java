...
final class TransactionProcessorImpl implements TransactionProcessor {
    ...
    private static final int rebroadcastAfter = Nxt.getIntProperty("caret.rebroadcastAfter") != 0 ? Nxt.getIntProperty("caret.rebroadcastAfter") : 4;
    private static final int rebroadcastEvery = Nxt.getIntProperty("caret.rebroadcastEvery") != 0 ? Nxt.getIntProperty("caret.rebroadcastEvery") : 2;
