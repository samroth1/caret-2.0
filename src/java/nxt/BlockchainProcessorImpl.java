...
final class BlockchainProcessorImpl implements BlockchainProcessor {
	public static final int BLOCKCACHEMB = Nxt.getIntProperty("caret.blockCacheMB") == 0 ? 40 : Nxt.getIntProperty("blockCacheMB");
	public static boolean oclVerify = Nxt.getBooleanProperty("caret.oclVerify");
	public static final int oclThreshold = Nxt.getIntProperty("caret.oclThreshold") == 0 ? 50 : Nxt.getIntProperty("caret.oclThreshold");
	public static final int oclWaitThreshold = Nxt.getIntProperty("caret.oclWaitThreshold") == 0 ? 2000 : Nxt.getIntProperty("caret.oclWaitThreshold");
