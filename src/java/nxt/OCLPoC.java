...
final class OCLPoC {
    ...
    private static final int hashesPerEnqueue = Nxt.getIntProperty("caret.oclHashesPerEnqueue") == 0 ? 1000 : Nxt.getIntProperty("caret.oclHashesPerEnqueue");
    private static final int memPercent = Nxt.getIntProperty("caret.oclMemPercent") == 0 ? DEFAULT_MEM_PERCENT : Nxt.getIntProperty("caret.oclMemPercent");
    ...
    static {
        try {
            boolean autoChoose = Nxt.getBooleanProperty("caret.oclAuto", true);
            ...
            if(autoChoose) {
                ...
                platformIndex = Nxt.getIntProperty("caret.oclPlatform");
                deviceIndex = Nxt.getIntProperty("caret.oclDevice");
            }
